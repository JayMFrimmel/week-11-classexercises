...
function Character(name, profession,gender, age, strength, hitpoints) {
	...
	this.printStats = function() {
		console.log("Name: " + this.name + "\nProfession: " + "\nGender: " + this.gender + "\nAge: " + this.age + "n\Strength: " + this.strength + "\nHitpoints: " + this.hitpoints);
		console.log("\n------------\n"); 
	};

	//method which determines whether or not a character's "hitpoints" are less than zero and returns true or false depending upon the outcome//
	...
	// creates two unique characters using the "Charaacter Constructor"//
	...
	// while loop which continues to run so long as both character's "hitpoints" are above zero //
